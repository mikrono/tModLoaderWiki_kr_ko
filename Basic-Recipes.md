...
```cs
Recipe recipe = Mod.CreateRecipe(ItemID.AlphabetStatueA);
...
```cs
Mod.CreateRecipe(ItemID.AlphabetStatueA)
...
Recipe recipe = Mod.CreateRecipe(ItemID.AlphabetStatueA); 
// other code
Recipe recipe = Mod.CreateRecipe(ItemID.AlphabetStatueB);
// other code
```
...
Recipe recipe = Mod.CreateRecipe(ItemID.AlphabetStatueA); 
// other code
recipe = Mod.CreateRecipe(ItemID.AlphabetStatueB); 
// other code
```
...
* ConsumeItemCallback
* RecipeAvailable
* [RecipeFinder/RecipeEditor](https://github.com/tModLoader/tModLoader/wiki/Intermediate-Recipes#editing-vanilla-recipes) -- Intermediate -- Allows you to modify and delete vanilla recipes.
