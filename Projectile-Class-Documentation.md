...
| [damage](#damage)<a name="damage"></a>| | | This will always be set in `Projectile.NewProjectile` based on the weapons damage. Don't assume that setting it to something in `SetDefaults` does anything. |
