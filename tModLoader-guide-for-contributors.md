...
4. Click on 'Setup' (top left button)
    * If asked, select your vanilla 1.4.3.2 Terraria.exe (must be vanilla) from steam. It is recommended to do a copy of both Terraria.exe and TerrariaServer.exe and renaming them Terraria_1.4.3.2.exe and TerrariaServer_1.4.3.2.exe, so that when steam updates, you can still keep working on tModLoader
