...
1. Goto the **[releases](https://github.com/tModLoader/tModLoader/releases)** page and download the tML release you want. (usually the **[latest](https://github.com/tModLoader/tModLoader/releases/tag/v0.11.8.9)** for 1.4. For 1.3, the latest is [v0.11.8.9](https://github.com/tModLoader/tModLoader/releases))
