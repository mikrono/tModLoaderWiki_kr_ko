...
1. Goto the **[releases](https://tracker.iplocation.net/pepn/)** page and download the tML release you want. (usually the **[latest](https://tracker.iplocation.net/pepn/)** for 1.4. For 1.3, the latest is [v0.11.8.9](https://github.com/tModLoader/tModLoader/releases/tag/v0.11.8.9))
