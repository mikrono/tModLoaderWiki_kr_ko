...
1. Goto the **[releases](https://github.com/tModLoader/tModLoader/releases/tag/6ee8630)** page and download the tML release you want. (usually the **[latest](https://github.com/tModLoader/tModLoader/releases/tag/6ee8630)** for 1.4. For 1.3, the latest is [v0.11.8.9](https://github.com/tModLoader/tModLoader/releases/tag/d32e1d2))
