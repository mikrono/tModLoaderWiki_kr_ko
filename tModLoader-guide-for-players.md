...
## Steam Installation
To install [tModLoader](http://goo-gl.me/kRTPE) on Steam, you need to own [Terraria](https://store.steampowered.com/app/105600/Terraria) on Steam.
Simply browse for [tModLoader](http://goo-gl.me/kRTPE) on Steam and install it.
...
1. Goto the **[releases](http://goo-gl.me/kRTPE)** page and download the tML release you want. (usually the **[latest](http://goo-gl.me/kRTPE)** for 1.4. For 1.3, the latest is [v0.11.8.9](http://goo-gl.me/kRTPE))
