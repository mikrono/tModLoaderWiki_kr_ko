The following is a list of constants found in the Terraria.ID.NPCID class. Simply use your browsers find function (ctrl-f) to find the correct NPCID. Most item ids will be the English name of the npc, but there are exceptions. If you can't find the npc here, look them up on the [official Terraria wiki](https://terraria.gamepedia.com/NPC_IDs) and then find the NPCID entry below. 
